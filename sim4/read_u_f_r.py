...
pad1=TPad("pad1","potential energy",0,0.5,0.99,0.99);
...
pad2=TPad("pad2","force",0.0,0.0,0.99,0.49)
...
tree.Draw("u:r","sp==0 && lj==1 && u<{} && -10<f<10".format(ylimit),"")
...
g1.SetName("g1")
g1.Draw("L")
legend1.AddEntry("g1","spline lj potential","l")

tree.Draw("u:r","sp==0 && lj==0","same")
...
g2.SetName("g2")
g2.Draw("L")
#legend1.AddEntry("g2","spline lj potential","l")

tree.Draw("u_old:r","u<{} && r>1.10".format(ylimit),"same")
...
g3.SetName("g3")
g3.Draw("L")
legend1.AddEntry("g3","traditional lj potential","l")
