...
'''=====================================
    ...
    ===================================='''
pad1.cd()
legend1 = TLegend(0.2, 0.75, .95, 0.83)
legend1.SetTextSize(0.05)

if nlines==1: #temp=1
    tree3.Draw("totalE_avg_v:Wdt","temp_id==1 && alpha_id==0 && totalE_avg_v<5","")
    g0=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    g0.SetTitle("r0=%.0f, v0=%.0f, alpha=%.1f" % (tree.r0,tree.v0,alpha0))
    g0.SetName("g0")
    g0.SetMarkerStyle(2)
    g0.SetLineWidth(2)
    g0.GetXaxis().SetTitle('#Omega_{0} dt')
    g0.GetYaxis().SetTitle('Total Average Energy')
    g0.GetXaxis().SetTitleSize(0.06)
    g0.GetYaxis().SetTitleSize(0.06)
    g0.Draw("LA PLC PFC")
    legend1.AddEntry("g0","avg energy (vel=v) temp={}".format(ttemp0),"l")
    
    tree3.Draw("totalE_avg_u:Wdt","temp_id==1 && alpha_id==0","same")
    g1=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    g1.SetName("g1")
    g1.SetMarkerStyle(2)
    g1.SetLineWidth(2)
    g1.Draw("L PLC PFC")
    legend1.AddEntry("g1","avg energy (vel=u) temp={}".format(ttemp0),"l")

if nlines==2: #temp=10
    tree3.Draw("totalE_avg_v:Wdt","temp_id==2 && alpha_id==0","same")
    g2=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    g2.SetTitle("r0=%.0f, v0=%.0f, alpha=%.1f" % (tree.r0,tree.v0,alpha0))
    g2.SetName("g2")
    g2.SetMarkerStyle(2)
    g2.SetLineWidth(2)
    g2.GetXaxis().SetTitle('#Omega_{0} dt')
    g2.GetYaxis().SetTitle('Total Average Energy')
    g2.GetXaxis().SetTitleSize(0.06)
    g2.GetYaxis().SetTitleSize(0.06)
    g2.Draw("LA PLC PFC")
    legend1.AddEntry("g2","avg energy (vel=v) temp={}".format(tttemp0),"l")

    tree3.Draw("totalE_avg_u:Wdt","temp_id==2 && alpha_id==0","same")
    g3=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    g3.SetName("g3")
    g3.SetMarkerStyle(2)
    g3.SetLineWidth(2)
    g3.Draw("L PLC PFC")
    legend1.AddEntry("g3","avg energy (vel=u) temp={}".format(tttemp0),"l")

if nlines==3: #temp=0.1
    tree3.Draw("totalE_avg_v:Wdt","temp_id==0 && alpha_id==0","same")
    g4=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    g4.SetTitle("r0=%.0f, v0=%.0f, alpha=%.1f" % (tree.r0,tree.v0,alpha0))
    g4.SetName("g4")
    g4.SetMarkerStyle(2)
    g4.SetLineWidth(2)
    g4.GetXaxis().SetTitle('#Omega_{0} dt')
    g4.GetYaxis().SetTitle('Total Average Energy')
    g4.GetXaxis().SetTitleSize(0.06)
    g4.GetYaxis().SetTitleSize(0.06)
    g4.Draw("LA PLC PFC")
    legend1.AddEntry("g4","avg energy (vel=v) temp={}".format(temp0),"l")
    
    tree3.Draw("totalE_avg_u:Wdt","temp_id==0 && alpha_id==0","same")
    g5=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    g5.SetName("g5")
    g5.SetMarkerStyle(2)
    g5.SetLineWidth(2)
    g5.Draw("L PLC PFC")
    legend1.AddEntry("g5","avg energy (vel=u) temp={}".format(temp0),"l")
...
'''=====================================
    ...
    ===================================='''
pad2.cd()
legend2 = TLegend(0.2, 0.75, .95, 0.83)
legend2.SetTextSize(0.05)

if nlines==1: #temp=1
    tree3.Draw("totalE_avg_v:Wdt","temp_id==1 && alpha_id==1 && totalE_avg_v<5","")
    ...
    gg0.SetLineWidth(2)
    gg0.GetXaxis().SetTitle('#Omega_{0} dt')
    gg0.GetYaxis().SetTitle('Total Average Energy')
    gg0.GetXaxis().SetTitleSize(0.06)
    gg0.GetYaxis().SetTitleSize(0.06)
    gg0.Draw("LA PLC PFC")
    legend2.AddEntry("gg0","avg energy (vel=v) temp={}".format(ttemp0),"l")

    tree3.Draw("totalE_avg_u:Wdt","temp_id==1 && alpha_id==1","same")
    gg1=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    gg1.SetName("gg1")
    gg1.SetMarkerStyle(2)
    gg1.SetLineWidth(2)
    gg1.Draw("L PLC PFC")
    legend2.AddEntry("gg1","avg energy (vel=u) temp={}".format(ttemp0),"l")

if nlines==2: #temp=10
    tree3.Draw("totalE_avg_v:Wdt","temp_id==2 && alpha_id==1","same")
    gg2=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    gg2.SetTitle("r0=%.0f, v0=%.0f, alpha=%.1f" % (tree.r0,tree.v0,aalpha0))
    gg2.SetName("gg2")
    gg2.SetMarkerStyle(2)
    gg2.SetLineWidth(2)
    gg2.GetXaxis().SetTitle('#Omega_{0} dt')
    gg2.GetYaxis().SetTitle('Total Average Energy')
    gg2.GetXaxis().SetTitleSize(0.06)
    gg2.GetYaxis().SetTitleSize(0.06)
    gg2.Draw("LA PLC PFC")
    legend2.AddEntry("gg2","avg energy (vel=v) temp={}".format(tttemp0),"l")

    tree3.Draw("totalE_avg_u:Wdt","temp_id==2 && alpha_id==1","same")
    gg3=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    gg3.SetName("gg3")
    gg3.SetMarkerStyle(2)
    gg3.SetLineWidth(2)
    gg3.Draw("L PLC PFC")
    legend2.AddEntry("gg3","avg energy (vel=u) temp={}".format(tttemp0),"l")

if nlines==3: #temp=0.1
    tree3.Draw("totalE_avg_v:Wdt","temp_id==0 && alpha_id==1","same")
    gg4=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    gg4.SetTitle("r0=%.0f, v0=%.0f, alpha=%.1f" % (tree.r0,tree.v0,aalpha0))
    gg4.SetName("gg4")
    gg4.SetMarkerStyle(2)
    gg4.SetLineWidth(2)
    gg4.GetXaxis().SetTitle('#Omega_{0} dt')
    gg4.GetYaxis().SetTitle('Total Average Energy')
    gg4.GetXaxis().SetTitleSize(0.06)
    gg4.GetYaxis().SetTitleSize(0.06)
    gg4.Draw("LA PLC PFC")
    legend2.AddEntry("gg2","avg energy (vel=v) temp={}".format(temp0),"l")
    
    tree3.Draw("totalE_avg_u:Wdt","temp_id==0 && alpha_id==1","same")
    gg5=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    gg5.SetName("gg5")
    gg5.SetMarkerStyle(2)
    gg5.SetLineWidth(2)
    gg5.Draw("L PLC PFC")
    legend2.AddEntry("gg2","avg energy (vel=u) temp={}".format(temp0),"l")
...
'''=====================================
    ...
    ===================================='''
pad3.cd()
legend3 = TLegend(0.2, 0.75, .95, 0.83)
legend3.SetTextSize(0.05)

if nlines==1: #temp=1
    tree3.Draw("totalE_avg_v:Wdt","temp_id==1 && alpha_id==2 && totalE_avg_v<5","")
    ...
    ggg0.SetLineWidth(2)
    ggg0.GetXaxis().SetTitle('#Omega_{0} dt')
    ggg0.GetYaxis().SetTitle('Total Average Energy')
    ggg0.GetXaxis().SetTitleSize(0.06)
    ggg0.GetYaxis().SetTitleSize(0.06)
    ggg0.Draw("LA PLC PFC")
    legend3.AddEntry("ggg0","avg energy (vel=v) temp={}".format(ttemp0),"l")

    tree3.Draw("totalE_avg_u:Wdt","temp_id==1 && alpha_id==2","same")
    ggg1=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    ggg1.SetName("ggg1")
    ggg1.SetMarkerStyle(2)
    ggg1.SetLineWidth(2)
    ggg1.Draw("L PLC PFC")
    legend3.AddEntry("ggg1","avg energy (vel=u) temp={}".format(ttemp0),"l")

if nlines==2: #temp=10
    tree3.Draw("totalE_avg_v:Wdt","temp_id==2 && alpha_id==2","same")
    ggg2=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    ggg2.SetTitle("r0=%.0f, v0=%.0f, alpha=%.1f" % (tree.r0,tree.v0,aaalpha0))
    ggg2.SetName("ggg2")
    ggg2.SetMarkerStyle(2)
    ggg2.SetLineWidth(2)
    ggg2.GetXaxis().SetTitle('#Omega_{0} dt')
    ggg2.GetYaxis().SetTitle('Total Average Energy')
    ggg2.GetXaxis().SetTitleSize(0.06)
    ggg2.GetYaxis().SetTitleSize(0.06)
    ggg2.Draw("LA PLC PFC")
    legend3.AddEntry("ggg2","avg energy (vel=v) temp={}".format(tttemp0),"l")

    tree3.Draw("totalE_avg_u:Wdt","temp_id==2 && alpha_id==2","same")
    ggg3=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    ggg3.SetName("ggg3")
    ggg3.SetMarkerStyle(2)
    ggg3.SetLineWidth(2)
    ggg3.Draw("L PLC PFC")
    legend3.AddEntry("ggg3","avg energy (vel=u) temp={}".format(tttemp0),"l")

if nlines==3: #temp=0.1
    tree3.Draw("totalE_avg_v:Wdt","temp_id==0 && alpha_id==2","same")
    ggg4=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    ggg4.SetTitle("r0=%.0f, v0=%.0f, alpha=%.1f" % (tree.r0,tree.v0,aaalpha0))
    ggg4.SetName("ggg4")
    ggg4.SetMarkerStyle(2)
    ggg4.SetLineWidth(2)
    ggg4.GetXaxis().SetTitle('#Omega_{0} dt')
    ggg4.GetYaxis().SetTitle('Total Average Energy')
    ggg4.GetXaxis().SetTitleSize(0.06)
    ggg4.GetYaxis().SetTitleSize(0.06)
    ggg4.Draw("LA PLC PFC")
    legend3.AddEntry("ggg4","avg energy (vel=v) temp={}".format(temp0),"l")
    
    tree3.Draw("totalE_avg_u:Wdt","temp_id==0 && alpha_id==2","same")
    ggg5=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    ggg5.SetName("ggg5")
    ggg5.SetMarkerStyle(2)
    ggg5.SetLineWidth(2)
    ggg5.Draw("L PLC PFC")
    legend3.AddEntry("ggg5","avg energy (vel=u) temp={}".format(temp0),"l")
...
'''=====================================
    ...
    ===================================='''
pad4.cd()
legend4 = TLegend(0.2, 0.75, .95, 0.83)
legend4.SetTextSize(0.05)

if nlines==1: #temp 1
    tree3.Draw("totalE_avg_v:Wdt","temp_id==1 && alpha_id==3 && totalE_avg_v<5","")
    ...
    gggg0.GetXaxis().SetTitle('#Omega_{0} dt')
    ...
    legend4.AddEntry("gggg0","avg energy (vel=v) temp={}".format(ttemp0),"l")

    tree3.Draw("totalE_avg_u:Wdt","temp_id==1 && alpha_id==3","same")
    gggg1=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    gggg1.SetName("gggg1")
    gggg1.SetMarkerStyle(2)
    gggg1.SetLineWidth(2)
    gggg1.Draw("L PLC PFC")
    legend4.AddEntry("gggg1","avg energy (vel=u) temp={}".format(ttemp0),"l")

if nlines==2: #temp=10
    tree3.Draw("totalE_avg_v:Wdt","temp_id==2 && alpha_id==3","")
    gggg2=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    gggg2.SetTitle("r0=%.0f, v0=%.0f, alpha=%.1f" % (tree.r0,tree.v0,aaaalpha0))
    gggg2.SetName("gggg2")
    gggg2.SetMarkerStyle(2)
    gggg2.SetLineWidth(2)
    gggg2.GetXaxis().SetTitle('#Omega_{0} dt')
    ...
    legend4.AddEntry("gggg2","avg energy (vel=v) temp={}".format(tttemp0),"l")

    tree3.Draw("totalE_avg_u:Wdt","temp_id==2 && alpha_id==3","same")
    gggg3=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    gggg3.SetName("gggg3")
    gggg3.SetMarkerStyle(2)
    gggg3.SetLineWidth(2)
    gggg3.Draw("L PLC PFC")
    legend4.AddEntry("gggg3","avg energy (vel=u) temp={}".format(tttemp0),"l")

if nlines==3: #temp=0.1
    tree3.Draw("totalE_avg_v:Wdt","temp_id==0 && alpha_id==3 && totalE_avg_v<5","")
    gggg4=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    gggg4.SetTitle("r0=%.0f, v0=%.0f, alpha=%.1f" % (tree.r0,tree.v0,aaaalpha0))
    gggg4.SetName("gggg4")
    gggg4.SetMarkerStyle(2)
    gggg4.SetLineWidth(2)
    gggg4.GetXaxis().SetTitle('#Omega_{0} dt')
    ...
    legend4.AddEntry("gggg4","avg energy (vel=v) temp={}".format(temp0),"l")

    tree3.Draw("totalE_avg_u:Wdt","temp_id==0 && alpha_id==3","same")
    gggg5=TGraph(tree3.GetSelectedRows(),tree3.GetV2(),tree3.GetV1())
    gggg5.SetName("gggg5")
    gggg5.SetMarkerStyle(2)
    gggg5.SetLineWidth(2)
    gggg5.Draw("L PLC PFC")
    legend4.AddEntry("gggg5","avg energy (vel=u) temp={}".format(temp0),"l")
...
'''
c1.Print("images/hmo/HMO_energy_dt_r{:.0f}_v{:.0f}_n10000000.pdf" % (tree.r0,tree.v0))
'''
