...
#pad1.cd()
if nlines>=1:
    tree_energy.Draw("totalE_avg_v:Wdt","totalE_avg_v<10","")
...
if nlines>=2:
    tree_energy.Draw("totalE_avg_u:Wdt","","same")
...
legend.AddEntry("g0","total energy average with full step velocity","l")
legend.AddEntry("g1","total energy average with half step velocity","l")
legend.Draw()
...
gPad.Print("images/HMO_energy_r%.0f_v%.0f.pdf" % (tree.r0,tree.v0))
