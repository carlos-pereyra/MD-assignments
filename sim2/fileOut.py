...
file=TFile("data/AtomBox_{}atoms_{}tSteps_{}dts_vx0_{:.0f}_vy0_{:.0f}.root".format(natom,nstep,ndt,vx[0],vy[0]), "recreate" );
...
#tree3.Branch('total_ke_v_sum',total_ke_v_sum,'total_ke_v_sum/F')
#tree3.Branch('total_ke_u_sum',total_ke_u_sum,'total_ke_u_sum/F')
#tree3.Branch('total_v_sum',total_v_sum,'total_v_sum/F')
#tree3.Branch('total_u_sum',total_u_sum,'total_u_sum/F')
