...
'''
c.cd()
tree.Draw("box.atoms.f.y:box.atoms.r.t","id==0 && t<20 && box.atoms.f.y>-500","")
...
tree.Draw("box.atoms.r.y:box.atoms.r.t","id==0 && t<20","same")
...
legend.AddEntry("g1","Wall Force-Y","l")
legend.AddEntry("g2","#nu","l")
legend.Draw()
c.Modified()
c.Update()

gPad.Print("images/fy_x_x{:.0f}_y{:.0f}_vx{:.0f}_vy{:.0f}.pdf".format(tree.box.atoms[0].rx0
                                                                        ,tree.box.atoms[0].ry0
                                                                        ,tree.box.atoms[0].vx0
                                                                        ,tree.box.atoms[0].vy0))
